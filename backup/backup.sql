...
-- Dumping data for table management_1.brands: ~0 rows (approximately)
...
INSERT INTO `companies` (`company_id`, `company_name`, `user_name`, `user_id`, `email`, `password`, `mobile`, `usertype`, `status`, `is_delete`, `created_at`, `updated_at`) VALUES
	...
	(2, 'CRYPTO TECHNOCRAFT PRIVATE LIMITED', 'admin', 'affy4365', 'ahadkhalid117@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', '07974857585', 0, 0, 0, NULL, NULL);
...
-- Dumping data for table management_1.users: ~0 rows (approximately)
